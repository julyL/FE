...
//   new P1 ,doResolve(fn1) =>   P1.then =>   new P2 => doResolve(constr1)  =>   P1.deferred.push(fn2)   =>P2.then   => doResolve(constr2)  => P2.deferred.push(fn3)    所有then都执行
//   fn1的resolve   =>   执行handle函数    =>  执行P1.deferred队列(fn2)[       =>  [[fn2的嵌套执行Sub   =>new P (sub)   => doResolve(fn sub)]]   =>     deferred.resolve(fn sub)]
//   =>    因为返回时function  => doResolve(then.bind(newValue))    =>     执行fn sub的then方法   =>  constr(sub)  => P sub.deferred.push()
//
//
