...
(function(global, factory) {
    typeof exports === 'object' && typeof module !== "undefined" ? module.exports = factory() :
        typeof define === 'function' && define.amd ? define(factory) : (global.imgLazyload = factory());
}(this, function() {
    ...
    var imgLazyload = function(config) {
        ...
        this.dataurl = config.dataurl || "data-original";
        ...
        this.animation = config.animation == "none" ? "none" : "fade";
        ...
        function _foreachImg(fn) { // 循环操作符图片(还没有执行onload和onerror的图片)
            var context = self;
            loadimgs = self.container.querySelectorAll("img[" + self.dataurl + "]");
        ...
        handler = function() {
            ...
            _foreachImg(function(img, index) {
                if (_isInview(img)) {
                    var originUrl = img.getAttribute(self.dataurl);
                    if (img.loadstatus) {
                    ...
                    image.addEventListener("load", function() {
                        ...
                        img.src = originUrl;
                        img.removeAttribute(self.dataurl);
                        img.setAttribute("data-imglazy", "loaded");
                        img.loadstatus = 'resolve';
                        if (self.animation == 'fade') { //默认动画fade
                            animation(img, {
                                opacity: 0
                            }, {
                                opacity: 1
                    ...
                    image.addEventListener("error", function() {
                        ...
                        img.removeAttribute(self.dataurl);
                        img.setAttribute("data-imglazy", "unload");
        ...
        _foreachImg(function(img) {
            ...
            img.setAttribute("data-imglazy", "loading");
        });
